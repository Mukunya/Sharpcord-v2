...
namespace ExampleBot
{
    ...
    //This attribute specifies the name of the logging context. (Log lines will appear as "[Timestamp] [Webhook example] This is a log message")
    [LogContext("Webhook example")]
